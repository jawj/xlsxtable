"use strict";var H=Object.defineProperty;var le=Object.getOwnPropertyDescriptor;var ne=Object.getOwnPropertyNames;var ie=Object.prototype.hasOwnProperty;var ce=(a,s)=>{for(var n in s)H(a,n,{get:s[n],enumerable:!0})},pe=(a,s,n,o)=>{if(s&&typeof s=="object"||typeof s=="function")for(let r of ne(s))!ie.call(a,r)&&r!==n&&H(a,r,{get:()=>s[r],enumerable:!(o=le(s,r))||o.enumerable});return a};var me=a=>pe(H({},"__esModule",{value:!0}),a);var De={};ce(De,{XlsxTypes:()=>re,createXlsx:()=>Ie});module.exports=me(De);var W,fe=()=>{let a=Int32Array,s=new a(256),n=new a(4096),o,r,i;for(r=0;r<256;r++)o=r,o=o&1?-306674912^o>>>1:o>>>1,o=o&1?-306674912^o>>>1:o>>>1,o=o&1?-306674912^o>>>1:o>>>1,o=o&1?-306674912^o>>>1:o>>>1,o=o&1?-306674912^o>>>1:o>>>1,o=o&1?-306674912^o>>>1:o>>>1,o=o&1?-306674912^o>>>1:o>>>1,n[r]=s[r]=o&1?-306674912^o>>>1:o>>>1;for(r=0;r<256;r++)for(i=s[r],o=256+r;o<4096;o+=256)i=n[o]=i>>>8^s[i&255];for(W=[s],r=1;r<16;r++)W[r]=n.subarray(r*256,(r+1)*256)},de=(a,s=0)=>{W||fe();let[n,o,r,i,E,$,A,P,w,C,L,t,e,k,f,h]=W,g=s^-1,v=a.length-15,c=0;for(;c<v;)g=h[a[c++]^g&255]^f[a[c++]^g>>8&255]^k[a[c++]^g>>16&255]^e[a[c++]^g>>>24]^t[a[c++]]^L[a[c++]]^C[a[c++]]^w[a[c++]]^P[a[c++]]^A[a[c++]]^$[a[c++]]^E[a[c++]]^i[a[c++]]^r[a[c++]]^o[a[c++]]^n[a[c++]];for(v+=15;c<v;)g=g>>>8^n[(g^a[c++])&255];return~g},he=typeof CompressionStream<"u",Y=new TextEncoder,q=a=>a.reduce((s,n)=>s+n.length,0),Z=Uint8Array;function ye(a){let s=new CompressionStream("gzip"),n=s.writable.getWriter(),o=s.readable.getReader();return n.write(a),n.close(),()=>o.read()}async function _(a,s=!0,n=ye){let o=[],r=he&&s,i=a.length,E=a.map(f=>Y.encode(f.path)),$=a.map(({data:f})=>typeof f=="string"?Y.encode(f):f instanceof ArrayBuffer?new Z(f):f),A=q($),P=q(E),w=i*46+P,C=A+i*30+P+w+22,L=new Date,t=new Z(C),e=0;for(let f=0;f<i;f++){o[f]=e;let h=E[f],g=h.length,v=$[f],c=v.length,D=a[f].lastModified??L,X=(D.getSeconds()/2|0)+(D.getMinutes()<<5)+(D.getHours()<<11),R=D.getDate()+(D.getMonth()+1<<5)+(D.getFullYear()-1980<<9),l=0,y=!1;t[e++]=80,t[e++]=75,t[e++]=3,t[e++]=4,t[e++]=20,t[e++]=0,t[e++]=0,t[e++]=8;let x=e;t[e++]=t[e++]=0,t[e++]=X&255,t[e++]=X>>8,t[e++]=R&255,t[e++]=R>>8;let m=e;if(e+=8,t[e++]=c&255,t[e++]=c>>8&255,t[e++]=c>>16&255,t[e++]=c>>24,t[e++]=g&255,t[e++]=g>>8,t[e++]=t[e++]=0,t.set(h,e),e+=g,r){let d=e,u=n(v),p,b=0,S=0;e:{for(;;){let F=await u();if(F.done)throw new Error("Bad gzip data");if(p=F.value,b=S,S=b+p.length,b<=3&&S>3&&p[3-b]&30){y=!0;break e}if(S>=10){p=p.subarray(10-b);break}}for(;;){let F=e-d,M=p.length;if(F+M>=c+8){y=!0;break e}t.set(p,e),e+=M;let O=await u();if(O.done)break;p=O.value}}if(y)for(;;){let F=p.length,M=8-F,O=e;e=d;for(let B=0;B<8;B++)t[e++]=B<M?t[O-M+B]:p[F-8+B];let z=await u();if(z.done)break;p=z.value}e-=8,t[m++]=t[e++],t[m++]=t[e++],t[m++]=t[e++],t[m++]=t[e++],e-=4,y||(t[x]=8,l=e-d)}if((!r||y)&&(t.set(v,e),e+=c,l=c),!r){let d=de(v);t[m++]=d&255,t[m++]=d>>8&255,t[m++]=d>>16&255,t[m++]=d>>24}t[m++]=l&255,t[m++]=l>>8&255,t[m++]=l>>16&255,t[m++]=l>>24}let k=e;for(let f=0;f<i;f++){let h=o[f],g=E[f],v=g.length;t[e++]=80,t[e++]=75,t[e++]=1,t[e++]=2,t[e++]=20,t[e++]=0,t[e++]=20,t[e++]=0,t.set(t.subarray(h+6,h+30),e),e+=24,t[e++]=t[e++]=t[e++]=t[e++]=t[e++]=t[e++]=t[e++]=t[e++]=t[e++]=t[e++]=0,t[e++]=h&255,t[e++]=h>>8&255,t[e++]=h>>16&255,t[e++]=h>>24,t.set(g,e),e+=v}return t[e++]=80,t[e++]=75,t[e++]=5,t[e++]=6,t[e++]=t[e++]=t[e++]=t[e++]=0,t[e++]=i&255,t[e++]=i>>8,t[e++]=i&255,t[e++]=i>>8,t[e++]=w&255,t[e++]=w>>8&255,t[e++]=w>>16&255,t[e++]=w>>24,t[e++]=k&255,t[e++]=k>>8&255,t[e++]=k>>16&255,t[e++]=k>>24,t[e++]=t[e++]=0,t.subarray(0,e)}var ge={"<":"&lt;",">":"&gt;","&":"&amp;","'":"&apos;",'"':"&quot;"},T=a=>a.replace(/[<>&'"]/g,s=>ge[s]),xe=a=>{let s="";for(;;){let n=a%26;if(s=String.fromCharCode(65+n)+s,a=(a-n)/26-1,a<0)return s}},N=(a,s)=>`${xe(a)}${s+1}`,ue=Date.UTC(1899,11,31)/1e3/3600/24,Q=a=>{let s=a.getTime()/1e3/3600/24-ue;if(!(s<1))return s>=60&&(s+=1),s};var j=`<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
