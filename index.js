"use strict";var H=Object.defineProperty;var le=Object.getOwnPropertyDescriptor;var ne=Object.getOwnPropertyNames;var ie=Object.prototype.hasOwnProperty;var ce=(a,s)=>{for(var n in s)H(a,n,{get:s[n],enumerable:!0})},pe=(a,s,n,o)=>{if(s&&typeof s=="object"||typeof s=="function")for(let r of ne(s))!ie.call(a,r)&&r!==n&&H(a,r,{get:()=>s[r],enumerable:!(o=le(s,r))||o.enumerable});return a};var me=a=>pe(H({},"__esModule",{value:!0}),a);var De={};ce(De,{XlsxTypes:()=>re,createXlsx:()=>Ie});module.exports=me(De);var W,fe=()=>{let a=Int32Array,s=new a(256),n=new a(4096),o,r,i;for(r=0;r<256;r++)o=r,o=o&1?-306674912^o>>>1:o>>>1,o=o&1?-306674912^o>>>1:o>>>1,o=o&1?-306674912^o>>>1:o>>>1,o=o&1?-306674912^o>>>1:o>>>1,o=o&1?-306674912^o>>>1:o>>>1,o=o&1?-306674912^o>>>1:o>>>1,o=o&1?-306674912^o>>>1:o>>>1,n[r]=s[r]=o&1?-306674912^o>>>1:o>>>1;for(r=0;r<256;r++)for(i=s[r],o=256+r;o<4096;o+=256)i=n[o]=i>>>8^s[i&255];for(W=[s],r=1;r<16;r++)W[r]=n.subarray(r*256,(r+1)*256)},de=(a,s=0)=>{W||fe();let[n,o,r,i,E,$,A,P,w,C,L,t,e,k,f,h]=W,x=s^-1,v=a.length-15,c=0;for(;c<v;)x=h[a[c++]^x&255]^f[a[c++]^x>>8&255]^k[a[c++]^x>>16&255]^e[a[c++]^x>>>24]^t[a[c++]]^L[a[c++]]^C[a[c++]]^w[a[c++]]^P[a[c++]]^A[a[c++]]^$[a[c++]]^E[a[c++]]^i[a[c++]]^r[a[c++]]^o[a[c++]]^n[a[c++]];for(v+=15;c<v;)x=x>>>8^n[(x^a[c++])&255];return~x},he=typeof CompressionStream<"u",z=new TextEncoder,q=a=>a.reduce((s,n)=>s+n.length,0),Z=Uint8Array;function ye(a){let s=new CompressionStream("gzip"),n=s.writable.getWriter(),o=s.readable.getReader();return n.write(a),n.close(),()=>o.read()}async function _(a,s=!0,n=ye){let o=[],r=he&&s,i=a.length,E=a.map(f=>z.encode(f.path)),$=a.map(({data:f})=>typeof f=="string"?z.encode(f):f instanceof ArrayBuffer?new Z(f):f),A=q($),P=q(E),w=i*46+P,C=A+i*30+P+w+22,L=new Date,t=new Z(C),e=0;for(let f=0;f<i;f++){o[f]=e;let h=E[f],x=h.length,v=$[f],c=v.length,D=a[f].lastModified??L,X=(D.getSeconds()/2|0)+(D.getMinutes()<<5)+(D.getHours()<<11),R=D.getDate()+(D.getMonth()+1<<5)+(D.getFullYear()-1980<<9),l=0,g=!1;t[e++]=80,t[e++]=75,t[e++]=3,t[e++]=4,t[e++]=20,t[e++]=0,t[e++]=0,t[e++]=8;let y=e;t[e++]=t[e++]=0,t[e++]=X&255,t[e++]=X>>8,t[e++]=R&255,t[e++]=R>>8;let m=e;if(e+=8,t[e++]=c&255,t[e++]=c>>8&255,t[e++]=c>>16&255,t[e++]=c>>24,t[e++]=x&255,t[e++]=x>>8,t[e++]=t[e++]=0,t.set(h,e),e+=x,r){let d=e,u=n(v),p,T=0,S=0;e:{for(;;){let F=await u();if(F.done)throw new Error("Bad gzip data");if(p=F.value,T=S,S=T+p.length,T<=3&&S>3&&p[3-T]&30){g=!0;break e}if(S>=10){p=p.subarray(10-T);break}}for(;;){let F=e-d,M=p.length;if(F+M>=c+8){g=!0;break e}t.set(p,e),e+=M;let O=await u();if(O.done)break;p=O.value}}if(g)for(;;){let F=p.length,M=8-F,O=e;e=d;for(let U=0;U<8;U++)t[e++]=U<M?t[O-M+U]:p[F-8+U];let Y=await u();if(Y.done)break;p=Y.value}e-=8,t[m++]=t[e++],t[m++]=t[e++],t[m++]=t[e++],t[m++]=t[e++],e-=4,g||(t[y]=8,l=e-d)}if((!r||g)&&(t.set(v,e),e+=c,l=c),!r){let d=de(v);t[m++]=d&255,t[m++]=d>>8&255,t[m++]=d>>16&255,t[m++]=d>>24}t[m++]=l&255,t[m++]=l>>8&255,t[m++]=l>>16&255,t[m++]=l>>24}let k=e;for(let f=0;f<i;f++){let h=o[f],x=E[f],v=x.length;t[e++]=80,t[e++]=75,t[e++]=1,t[e++]=2,t[e++]=20,t[e++]=0,t[e++]=20,t[e++]=0,t.set(t.subarray(h+6,h+30),e),e+=24,t[e++]=t[e++]=t[e++]=t[e++]=t[e++]=t[e++]=t[e++]=t[e++]=t[e++]=t[e++]=0,t[e++]=h&255,t[e++]=h>>8&255,t[e++]=h>>16&255,t[e++]=h>>24,t.set(x,e),e+=v}return t[e++]=80,t[e++]=75,t[e++]=5,t[e++]=6,t[e++]=t[e++]=t[e++]=t[e++]=0,t[e++]=i&255,t[e++]=i>>8,t[e++]=i&255,t[e++]=i>>8,t[e++]=w&255,t[e++]=w>>8&255,t[e++]=w>>16&255,t[e++]=w>>24,t[e++]=k&255,t[e++]=k>>8&255,t[e++]=k>>16&255,t[e++]=k>>24,t[e++]=t[e++]=0,t.subarray(0,e)}var ge={"<":"&lt;",">":"&gt;","&":"&amp;","'":"&apos;",'"':"&quot;"},b=a=>a.replace(/[<>&'"]/g,s=>ge[s]),xe=a=>{let s="";for(;;){let n=a%26;if(s=String.fromCharCode(65+n)+s,a=(a-n)/26-1,a<0)return s}},N=(a,s)=>`${xe(a)}${s+1}`,ue=Date.UTC(1899,11,31)/1e3/3600/24,Q=(a,s=!1)=>{let o=Date.UTC(a.getFullYear(),a.getMonth(),a.getDate(),a.getHours(),a.getMinutes(),a.getSeconds(),a.getMilliseconds())/1e3/3600/24-ue;if(!(o<0)&&!(o<1&&!s))return o>=60&&(o+=1),o};var j=`<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
...
<cp:coreProperties
  ...
  <cp:lastModifiedBy>${b(n)}</cp:lastModifiedBy>
...
</styleSheet>`;var re=(i=>(i[i.Number=0]="Number",i[i.String=1]="String",i[i.DateTime=2]="DateTime",i[i.Date=3]="Date",i[i.Time=4]="Time",i))(re||{}),Se={4:!0,3:!0,2:!0},Fe={4:10,3:12,2:20},se=6,I=42,B=2,K=1.1,we=Math.ceil(I/K)-B,ke=I-B,Ie=({headings:a,types:s,data:n,wrapText:o,freeze:r,autoFilter:i,creator:E,title:$,description:A,sheetName:P,company:w})=>{let C=a.length;if(C!==s.length||C!==n[0].length)throw new Error("Number of headings, types and data columns must match");let L=n.length,t=new Date,e=new Map,k=0,f=0,h=[],x=B+(i?2:0);for(let l=0;l<C;l++){let y=a[l].length*K+x;h[l]=y<se?se:y>I?I:y}for(let l=0;l<C;l++){if(h[l]>=I)continue;let g=s[l],y=Fe[g];if(y!==void 0){h[l]<y&&(h[l]=y);continue}if(g===1){let m=0;for(let u=0;u<L;u++){let p=n[u][l];if(p==null)continue;p=String(p);let T=-1,S,F=p.length;for(;;){S=p.indexOf(`
`,T+1),S===-1&&(S=F);let M=S-T;if(M>m&&(m=M),S===F)break;T=S}if(m>=we)break}let d=m*K+B;h[l]<d&&(h[l]=d>I?I:d)}else if(g===0){let m=0;for(let u=0;u<L;u++){let p=n[u][l];if(p==null)continue;p=String(p);let T=p.length;if(T>m&&(m=T),m>=ke)break}let d=m+B;h[l]<d&&(h[l]=d>I?I:d)}}let v=`<cols>${h.map((l,g)=>`<col min="${g+1}" max="${g+1}" width="${Math.ceil(l)}" bestFit="1" customWidth="1" />`).join("")}</cols>`,c=`<row r="1" spans="1:${C}">${a.map((l,g)=>`<c r="${N(g,0)}" t="inlineStr" s="1"><is><t>${b(l)}</t></is></c>`).join("")}</row>`,D=`${n.map((l,g)=>`<row r="${g+2}" spans="1:${C}">${l.map((y,m)=>{if(y==null)return"";let d=s[m],u;if(d in Se&&(u=d===4?4:d===3?3:2,y instanceof Date&&(d===4&&y.setUTCFullYear(1899,11,31),y=Q(y,d===4)??y.toISOString()),typeof y=="string"&&(d=1)),d===1){k++;let p=e.get(y);return p===void 0&&(p=f,e.set(y,p),f++),`<c r="${N(m,g+1)}" t="s"><v>${p}</v></c>`}return`<c r="${N(m,g+1)}"${u?` s="${u}"`:""}><v>${y}</v></c>`}).join("")}</row>`).join("")}`,X=`<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<sst xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main" count="${k}" uniqueCount="${f}">
${[...e].map(([l])=>`<si><t>${b(l)}</t></si>`).join("")}
